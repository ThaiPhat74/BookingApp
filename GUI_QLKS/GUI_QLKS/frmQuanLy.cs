...
namespace GUI_QLKS
{
    public partial class frmQuanLy : Form
    {
        ...
        public void loadRoomTheoLoai(int maLoai,string st)
        {
            flpnPhong.Controls.Clear();
            List<Room> roomList = RoomDAL.Instance.LoadRoomListByIdType(maLoai,st);
        ...
        void LoadCBRoomType(ComboBox comboBox)
        {
            comboBox.DataSource = RoomTypeDAL.Instance.loadRTList();
        ...
        private void frmQuanLy_Load(object sender, EventArgs e)
        {
            ...
            LoadComboboxRoom(cbRoomFrom);
            LoadComboboxRoom(cbRoomTo);
            LoadCBRoomType(cbRoomType);
            loadRoomStatus(cbStatus);
        }
        ...
        private void flpnPhong_Paint(object sender, PaintEventArgs e)
        {
        ...
        {
            int idType = (cbRoomType.SelectedItem as RoomType).Id;
            string st = (cbStatus.SelectedItem as Room).TrangThai;
            loadRoomTheoLoai(idType, st);
        }
